...
const __dirname$1 = require$$1.dirname(__filename);
mainExports$1.config({ path: require$$1.join(__dirname$1, `../../.env.${process.env.NODE_ENV}`) });
...
async function createWindow() {
  const win = new BrowserWindow({
    ...
    height: 768,
    webPreferences: {
      preload: require$$1.join(__dirname$1, preloadPath),
  ...
  if (isDev) {
    ...
    win.loadFile(require$$1.join(__dirname$1, renderPath));
    win.webContents.openDevTools();
  }
